...
struct ContentView: View {
    ...
    @State private var editingItem: FurrhythmItem?
    ...
    private var emptyState: some View {
        VStack(spacing: 12) {
            ...
            Text("Tap + to add your first symptom.")
                .font(Theme.captionFont)
                .foregroundStyle(Theme.textSecondary)
        }
    }

    private func row(for item: FurrhythmItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: FurrhythmItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
